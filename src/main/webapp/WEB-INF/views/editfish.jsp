...
<h1>Think you caught your Personal Best? Lets record It!</h1>
	<div align="center">
		<form:form action="update" method="post" modelAttribute="fish">
			<h2>Edit Fish (id: ${fish.id})</h2>
			<table border="0" cellpadding="5">
				<tr>
					...
					<tr>
					<td>Id:</td>
					<td><form:input path="id" readonly="true" value="${fish.id}" /></td>
				</tr>
				<tr>
					<td>Color:</td>
